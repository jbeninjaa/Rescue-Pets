        ...
        <article>
          ...
          <section class="full-width background-dark">
            <div class="s-12 m-12 l-6">
              ...
              <div style="background-image: url(<?=ASSETS?>resc/img/disable-dog-wheelchair.jpg);" class="contact-image" ></div>
            </div>
            <div class="s-12 m-12 l-6 text-center">
              <div class="padding-2x">
                <i class="icon-sli-location-pin text-white text-size-30 center"></i>
                <h2 class="text-size-20 margin-bottom-0 text-white">AARRC Address</h2>                
                <p>Paraiso Rd</p>
                <p>Banga</p>
                <p>5601 Aklan</p>
                ...
                <a class="text-primary-hover" href="mailto:contact@sampledomain.com">aklananimalrescue@gmail.com</a><br>
                <a class="text-primary-hover" href="mailto:office@sampledomain.com">jclupera@up.edu.ph</a><br>
                <a class="text-primary-hover" href="mailto:office@sampledomain.com">fnconanan@up.edu.ph</a>
                ...
                <p>NL +31 (0) 618535708</p>
                <p>PH +63 (0) 9123349770</p>
